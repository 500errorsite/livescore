...
<meta property="og:title"         content="<?=$GetTitle?> / LiveScoreBeta.com" />
...
<!-- Custom CSS -->
<link rel="stylesheet" media="screen" href="/css/ls/styler.css?c=<?=$ThemeColor?>">
<!-- Custom JS -->
...
<body class="om soccer mob">
    ...
    <div class="results">
        ...
        <div class="row md-footer bb">
            <?php 
            // Copyright Text Removal START line
            // Zumset Copyright text and links - Remove only if you purchased "Copyright Text Removal"
            // If texts and links are removed or changed, your license will be suspended and you will not be able download the latest updates or install the script again
            ?>
            
           <?php include ('./inc/footer.php'); ?>
            <?php // Copyright Text Removal END line ?>
        </div>
        <script type="text/javascript">com.livescore.MatchDetailWidget.init('soccer');</script>
    </div>
